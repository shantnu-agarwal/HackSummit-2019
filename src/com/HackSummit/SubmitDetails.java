...
public class SubmitDetails extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            query = "insert into mytable(Id,Created_on,Operation,Type,Area,Country,RENT_INR,TSA_in_m2,Floor,Rooms,description,City,image_thumbnail) values ('"+randomAlphaNumeric(40)+"','"+ "2019-08-31"+ "','rent','"+
                   0 +"','" + InputArea + "','India','" + InputPrice +"','" + InputTSA+ "','"+ InputFloors+ "','" + InputRooms + "','"+ InputDesc + "','Mumbai','"+ "NULL" + "');";
            System.out.println(query);
            statement.executeUpdate(query);
